    ...
    <div className='bgcolor'>
      <div className="firstsection">
        ...
        <div className="maincontainer">
          ...
          <div className="maincontent">
            At Placement Portal, we are dedicated to fostering your professional growth and connecting you with rewarding
      ...
      <div className="footer">
        ...
        <div className="links">
          ...
          <a href="#">Online Support System</a>
        </div>
        <div className="address">
          <h4>Placement Portal</h4>
          <h4>P.O. Box KUNIAMUTHUR,</h4>
          <h4>COIMBATORE,</h4>
          <h4>Pin -641008, India</h4>
        </div>
      </div>
    </div>
  )
