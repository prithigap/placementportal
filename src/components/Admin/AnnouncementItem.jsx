         ...
         <div className="w-50 m-2">
             <div className="card w-100 mb-3">
                 <div className="card-body d-flex justify-align-align-content-xl-between gap-5">
                     <div>
                         <svg className="my-1 mx-5" xmlns="http://www.w3.org/2000/svg" height="52" width="52" viewBox="0 0 576 512">
                         ...
                         <div className="d-flex flex-column align-items-center">
                             <div className="m-1">
                                 ...
                                 <i
                                     ...
                                     onClick={() => updateAnnouncement(announcement)} // Pass entire announcement
                                 ></i>
                             </div>
                         </div>
                     </div>
